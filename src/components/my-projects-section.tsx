...
export default function MyProject() {
  ...
  return (
    <section id="projects" className="w-full min-h-screen flex items-center mx-2">
      <Gallery
      ...
      <div className="w-full flex flex-col">
        <h2 className="text-emerald-400 vend-sans text-[45px] px-4">Projetos</h2>
        ...
        <p className="text-[15px] text-[#555353] px-4 mb-10">
          ...
          <a 
            ...
            href="https://github.com/iago193?tab=repositories">Github.</a>
        </p>
        ...
        <div className="w-full pb-10 flex flex-wrap px-2">
          {works.map((work, index) => (
            <div
              ...
              style={{
                transform: `
                  ${tiltStyles[index] || 'perspective(600px) rotateX(0deg) rotateY(0deg) scale(1)'}
                  ${!visibleCards[index] ? ' translateX(-80px)' : ' translateX(0px)'}
                `,
