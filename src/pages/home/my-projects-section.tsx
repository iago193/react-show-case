            ...
            >
              <div className="w-full p-4 relative">
                ...
                <div className="absolute flex top-6 right-6 gap-2">
                  <button
                    type="button"
                    className="bg-black/90 text-amber-50 rounded-[50%] flex justify-center items-center w-6 shadow-[inset_0_0_6px_2px_rgba(255,255,255,0.2)]"
                  >
                    <GrGallery size={12} />
                  </button>
                  <button
                    type="button"
                    className="bg-black/90 block p-0.5 rounded-[50%] w-6 shadow-[inset_0_0_6px_2px_rgba(255,255,255,0.2)]"
                  >
                    <a
                      href={work.url}
                      target="_blank"
